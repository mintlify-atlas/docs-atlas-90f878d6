...
description: "Use Codex, an IDE assistant, or a CLI agent to compile opening packages from files. Operator controls source selection, authority, and final approval."
---
