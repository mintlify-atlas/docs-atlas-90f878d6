...
description: "Canonical reference for 02_PROTOCOL.md — defines the minimum working procedure, state machine, intake requirements, stop conditions, and output minimums for Project Forge."
---
