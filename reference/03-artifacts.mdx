...
description: "Canonical reference for 03_ARTIFACTS.md — highest authority on artifact surface and grammar, defining all baseline artifact classes, schemas, triggers, and custom artifact rules."
---
